...
dados (
    ...
    VALUES
        ('ana.dias.004@example.com', 6, 'Integração para uso de EPI', 'Treinamento prático sobre seleção, utilização, conservação e substituição de equipamentos de proteção individual.', 'https://treinamentos.astro.local/nr-06', 'COLABORADOR', FALSE, 'CONCLUIDO', NULL, NULL),
        ...
        ('ana.ferreira.005@example.com', 10, 'Segurança elétrica no canteiro', 'Treinamento para identificação e controle de riscos elétricos temporários no canteiro.', 'https://treinamentos.astro.local/nr-10-construcao', 'COLABORADOR', FALSE, 'CONCLUIDO', NULL, NULL),
        ...
        ('ana.gomes.006@example.com', 31, 'Segurança nas atividades rurais', 'Treinamento sobre riscos ocupacionais nas operações agrícolas e medidas preventivas.', 'https://treinamentos.astro.local/nr-31', 'COLABORADOR', FALSE, 'CONCLUIDO', NULL, NULL),
